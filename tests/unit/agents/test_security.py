...
class TestSecurityAgent:
    ...
    def test_create_security_agent(self, mock_agent_cls: MagicMock, mock_opus: MagicMock) -> None:
        ...
        # 11 tools: git_read, git_list, git_write_security, checkov_scan, write_security_review,
        # read_task_ledger, create_board_task, update_board_task, add_task_comment, report_activity, web_search
